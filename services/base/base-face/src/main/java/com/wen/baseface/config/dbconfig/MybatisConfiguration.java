package com.wen.baseface.config.dbconfig;
...
import com.wen.baseface.util.SpringContextUtil;
...
@MapperScan(basePackages="com.wen.baseface.dao")
public class MybatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactorys() throws Exception {
       ...
       //     sessionFactoryBean.setDataSource(roundRobinDataSouce);
            ...
            // 读取配置 
            sessionFactoryBean.setTypeAliasesPackage("com.wen.baseface.model");
